...
timeout(10){util_init.get_repo('checkin_test_dtu_kmd.xml')}
...
try{
    ...
    timeout(20){util_make.load_kmd('profiler_4c32s')}
    timeout(120){util_test.profiler_test("32", "4", "true", "bf16", "CHNW", "env_setup_4c32_checkin.sh")}
